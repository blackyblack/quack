...
public final class JSONResponses {
    ...
    public static final JSONStreamAware MISSING_TITLE = missing("title");
    public static final JSONStreamAware MISSING_PRICE_PASS = missing("price");
    public static final JSONStreamAware MISSING_SHIPPING_COST1 = missing("shippingCost1");
    public static final JSONStreamAware MISSING_SHIPPING_COST2 = missing("shippingCost2");
    public static final JSONStreamAware MISSING_SHIPPING_COST3 = missing("shippingCost3");
    public static final JSONStreamAware INCORRECT_SHIPPING_COST1 = incorrect("shippingCost1");
    public static final JSONStreamAware INCORRECT_SHIPPING_COST2 = incorrect("shippingCost2");
    public static final JSONStreamAware INCORRECT_SHIPPING_COST3 = incorrect("shippingCost3");
    public static final JSONStreamAware INCORRECT_MESSAGE_LENGTH = incorrect("message", "(length must be not longer than " + Constants.MAX_ARBITRARY_MESSAGE_LENGTH + " characters)");
    public static final JSONStreamAware MISSING_LISTING_ID = missing("listing_id");
    public static final JSONStreamAware MISSING_VERSION = missing("version");
    public static final JSONStreamAware INCORRECT_VERSION = incorrect("version");
    public static final JSONStreamAware MISSING_SHIPPING_ADDRESS = missing("shippingAddress");
    public static final JSONStreamAware INCORRECT_GOODS_NOT_ACTIVE = incorrect("goods", "(should be in ACTIVE state)");
    public static final JSONStreamAware MISSING_FINAL_PRICE = missing("finalPrice");
    public static final JSONStreamAware INCORRECT_FINAL_PRICE = incorrect("finalPrice");
    public static final JSONStreamAware INCORRECT_MARKET = incorrect("market");
    public static final JSONStreamAware MISSING_REQUEST = missing("request");
    public static final JSONStreamAware UNKNOWN_REQUEST = unknown("request");
    public static final JSONStreamAware MISSING_BUYING_ID = missing("buying_id");
    public static final JSONStreamAware MISSING_ITEMS = missing("items");
    public static final JSONStreamAware INCORRECT_ITEMS = incorrect("items");
    public static final JSONStreamAware INCORRECT_ESCROW = incorrect("escrow");
    public static final JSONStreamAware INCORRECT_ISBUYER = incorrect("isBuyer");
    public static final JSONStreamAware MISSING_LOCK_ID = missing("lock_id");
    
    
    public static final JSONStreamAware NOT_ENOUGH_FUNDS;
    static {
        JSONObject response = new JSONObject();
        response.put("query_status", "bad");
    ...
    public static JSONStreamAware unknown(String objectName) {
        JSONObject response = new JSONObject();
        response.put("query_status", "bad");
        response.put("errorCode", 5);
